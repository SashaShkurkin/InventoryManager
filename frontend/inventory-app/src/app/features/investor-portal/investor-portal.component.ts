    ...
    <div class="portal-wrap">
      <mat-card class="portal-card">
        <mat-card-content>
          ...
          <p>Sign in with your registered Google account to view your investment dashboard.</p>
...
export class InvestorPortalComponent implements AfterViewInit {
  ...
  constructor() {
    effect(() => {
      if (this.auth.isInvestor()) this.router.navigate(['/investor/dashboard']);
    });
  }

  ngAfterViewInit() {
    this.auth.renderButton(this.googleBtnEl.nativeElement, 'investor');
  }
}
